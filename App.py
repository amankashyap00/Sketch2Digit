...
def predictDigit(image):
    model = tf.keras.models.load_model("model/dataset.h5")
...
st.sidebar.text("Created by Aman Kashyap")
st.sidebar.text("GitHub Repository")
st.sidebar.write("[GitHub Repo Link](https://github.com/xcreatex/Sketch2Digit)")
